  ...
  template: `
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-32">
      ...
      <div class="absolute inset-0 z-0">
        ...
        <!-- Grid pattern -->
        <div class="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)] hero-bg-parallax" data-speed="0.15"></div>
      </div>
      ...
      <div class="container mx-auto px-6 relative z-10 text-center max-w-5xl">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 hero-element opacity-0">
          <a href="#dashboard-section" class="px-8 py-4 bg-white text-zinc-950 rounded-full font-medium hover:bg-zinc-200 transition-colors w-full sm:w-auto flex items-center justify-center gap-2">
            <mat-icon>play_circle</mat-icon>
            View Live Demo
          </a>
          <a href="#references-section" class="px-8 py-4 bg-white/10 text-white rounded-full font-medium hover:bg-white/20 transition-colors border border-white/10 w-full sm:w-auto flex items-center justify-center gap-2">
